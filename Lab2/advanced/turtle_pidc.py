...
class MoveTurtlePIDControl:
    def __init__(self):
        ...
        # Publicar en los topics de comandos y datos de error
        self.velocity_publisher = rospy.Publisher('/turtle1/cmd_vel', Twist, queue_size=10)
        self.error_publisher = rospy.Publisher('/turtle/error_x', Float32, queue_size=10)
        self.vel_publisher = rospy.Publisher('/turtle/vel_x', Float32, queue_size=10)
    ...
    def move_turtle_to_desired_x(self, desired_x):
        ...
        while not rospy.is_shutdown():
            ...
            self.vel_publisher.publish(vel_x)
